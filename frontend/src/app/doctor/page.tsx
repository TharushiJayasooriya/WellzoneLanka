            ...
            <div className="bg-white p-10 rounded-lg border border-gray-200 shadow-lg">
              <div className="space-y-6">
                <div>
                  ...
                  <h2 className="text-xl font-medium text-gray-600">Join the <span className="text-blue-600 font-semibold">WellZone Lanka</span> healthcare network</h2>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <form onSubmit={handleSubmit} className="px-2 sm:px-6">
                    ...
                    <div className="mt-5">
                      <label className="text-sm font-medium text-gray-700 mb-1 block">Hospital/Clinic</label>
                      <div className="relative">
                        <input
                          type="text"
                    ...
                    <div className="mt-5 p-4 border border-dashed border-gray-300 rounded-md bg-gray-50">
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-sm text-gray-700 font-medium">Upload License Document</p>
                        <p className="text-xs text-gray-500 mt-1 text-center">
                          Upload a scanned copy of your medical license (PDF or JPG)
                        </p>
                        <input
                          type="file"
                    ...
                    <button className="w-full mt-5 bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-md font-medium shadow-sm hover:shadow-md transition-all"
                      disabled={pending}
                    >
                      Register as Doctor
                    </button>
