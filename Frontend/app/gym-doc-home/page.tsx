  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl w-full text-black">
          <UserPhaseCard
            title="Doctor"
          ...
          <UserPhaseCard
            title="Patient"
            description="Manage your health journey"
            details="Track your health metrics, manage appointments, and access your medical records."
