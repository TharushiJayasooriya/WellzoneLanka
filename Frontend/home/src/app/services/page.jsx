  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-cyan-50 overflow-x-hidden">
      ...
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <video src="\assets\y.mp4" autoPlay loop muted playsInline className="object-cover w-full h-full absolute" />
      ...
      <div id="services" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div
          ...
          style={{
            opacity: isVisible["services-heading"] ? 1 : 0,
            transform: isVisible["services-heading"] ? "translateY(0)" : "translateY(20px)",
          }}
        >
        ...
        <div
          ...
          style={{
            opacity: isVisible["services-showcase"] ? 1 : 0,
            transform: isVisible["services-showcase"] ? "translateY(0)" : "translateY(20px)",
          }}
        >
        ...
        <div id="cta-section" className="my-32 text-center" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div className="space-y-8">
                  ...
                  <div className="group" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div className="flex items-center mt-4">
                      ...
                      <p className="text-gray-600 text-left transition-all duration-300 group-hover:text-blue-600">
                        Connect with certified gym trainers for personalized workout plans
                      </p>
                    </div>
                  </div>

                  {/* Health Checkups Button */}
                  <div className="group" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <div className="flex items-center mt-4">
                      ...
                      <p className="text-gray-600 text-left transition-all duration-300 group-hover:text-blue-600">
                        Connect with qualified doctors for comprehensive health assessments
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {[
              {
                ...
                answer:
                  "Our team offers free consultations to assess your needs and goals. We'll recommend the most suitable services based on your individual requirements.",
              },
              {
                question: "Can I combine fitness and medical services?",
                answer:
                  "Absolutely! In fact, we encourage a holistic approach to wellness. Many of our members benefit from both our fitness programs and medical services.",
              },
              {
                question: "What qualifications do your trainers and medical staff have?",
                answer:
                  "All our fitness trainers are certified professionals with extensive experience. Our medical staff includes licensed physicians, physiotherapists, and health counselors.",
              },
              {
                question: "Do you offer any packages or membership options?",
                answer:
                  "Yes, we offer various membership tiers and packages that provide access to multiple services at discounted rates. Contact us for more details.",
              },
            ].map((faq, index) => (
