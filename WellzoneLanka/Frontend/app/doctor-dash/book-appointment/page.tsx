            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <option value="dr-johnson">Dr. Johnson(Orthopedic Physiotherapist)</option>
                  <option value="dr-williams">Dr. Williams (Neurological Physiotherapist)
                  </option>
                </select>
              </div>
        ...
        {showSuccessDialog && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 max-w-md w-full">
              ...
              <Link href="/doctor-dash/my-appointments" className="px-4 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-700 transition-colors" onClick={() => setShowSuccessDialog(false)}>
